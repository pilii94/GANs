...
def generate_plot(examples, epoch, n=7):
...
if __name__ == '__main__':
	...
	dataset = load_real_samples()
 	train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=5000)
